...
class Customer extends \Controller
{
	...
	public static function getItems($arrConfig, $intLimit = 0, $intOffset = 0, $arrOptions = array())
	{
		try
		{
			$objItems = CustomerModel::findItems($arrConfig, $intLimit, $intOffset, $arrOptions);
	...
	/**
	 * Get Customer
	 * @param  [Mixed] $varItem   [Customer ID, Alias, Array or Object]
	 * @param  [Array] $arrConfig [Customer configuration]
	...
	public static function getItem($varItem, $arrConfig = array())
	{
		try
		{
			...
			{
				$sql = CustomerModel::findByIdOrAlias($varItem);
	...
	public static function countItems($arrConfig, $arrOptions = array())
	{
		try
		{
			return CustomerModel::countItems($arrConfig, $arrOptions);
		}
		catch(Exception $e)
		{
			throw $e;
