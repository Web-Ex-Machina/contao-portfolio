...
class LoadDataContainerListener
{
    ...
    public function addAttributesToPortfolioDca($strTable): void
    {
        try {
            ...
            $this->logger->log('ERROR', vsprintf(key_exists('ERROR',$GLOBALS['TL_LANG']['WEM']['PORTFOLIO']) ? $GLOBALS['TL_LANG']['WEM']['PORTFOLIO']['ERROR']['generic']: "coucou", [$exception->getMessage(), $exception->getTrace()]), ["WEM_OFFERS"]);
        }
    }
